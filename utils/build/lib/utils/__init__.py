...
def save_image_to_file(image, path_name):
    #print("save_image_to_file = ", image.shape, path_name)
    cv2.imwrite(path_name, image) # Write the image gray to a file with name
